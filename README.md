...
**Optional — routine tick interval (F6.T4.S2):** set **`CUBE_ROUTINE_TICK_SEC`** to a positive number (seconds) to evaluate time-based routines on a fixed schedule while the gateway is up. Unset or zero disables the background task.
